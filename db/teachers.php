  ...
  <body>
    <div class="container">
      <nav>
        ...
        <ul>
          <li class="list-items">
            <a href="./generate.php" class="generate"
          ...
          <li class="list-items">
            <a href="./teachers.php" class="active" target="_top"
          ...
          <li class="list-items">
            <a href="./subject.php" target="_parent"
      ...
      <section class="main-content">
        <div class="main-logo"><h1>Add <span>Instructor</span></h1><i class="fa-solid fa-user"></i>
        </div>
        <div class="inputs">
          <form  action="add_teachers.php" method ="post">
            <div class="names">
              <div class="teacher-name">
                <span
                  >First name<span style="color: red; font-size: 1.3em"
                    >*</span
                  ></span
                >
                <input
              ...
              <div class="teacher-name">
                <span
                  >Last name<span style="color: red; font-size: 1.3em"
                    >*</span
                  ></span
                >
                <input
            ...
            <div class="day-time">
              <div class="dropdown-time">
                <span class="input-info"
                  >Select time<span style="color: red; font-size: 1.3em"
                    >*</span
                  ></span>
                <input
                required
                  type="text"
                  class="textbox-time input"
              ...
              <div class="dropdown-day">
                <span class="input-info"
                >Select day<span style="color: red; font-size: 1.3em;"
                  >*</span
                ></span>
            ...
            <div class="subject-strand">
              <div class="strand-list">
                <span class="input-info"
                >Select strand<span style="color: red; font-size: 1.3em"
                  >*</span
                ></span>
                <input
                  type="text"
                  name="strand"
                  class="textbox-strands input"
                  placeholder="No strand selected"
                  readonly
                  required
                /> 
              ...
              <div class="subject-list">
                <span class="input-info"
                >Select subject<span style="color: red; font-size: 1.3em"
                  >*</span
                ></span>
