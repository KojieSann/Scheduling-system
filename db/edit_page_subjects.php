        ...
        <div class="inputs">
          ...
          <input type="hidden" name="id" value="<?php echo $id; ?>">
            <div class="subject-code">
              <div class="subj-code">
                <span
                  >Subject<span style="color: red; font-size: 1.3em"
                    >*</span
                  ></span
                >
                <input
              ...
              <div class="subj-code">
                <span
                  >Subject Code<span style="color: red; font-size: 1.3em"
                    >*</span
                  ></span
                >
                <input
            ...
            <div class="yrlvl-gradelvl">
              <div class="year-level">
                <span
                  >School Year<span style="color: red; font-size: 1.3em"
                    >*</span
                  ></span
                >
                <input
              ...
              <div class="dropdown-gradelvl">
                ...
                <input
                  type="text"
                  class="textbox-grade input"
                  placeholder="No grade level selected"
                  readonly
                  name="grade_level"
            ...
            <table class="table">
              ...
              <?php
                ...
                while($row = $result->fetch_assoc()) {
                  ...
                  echo "<td> <a href='edit_page_subjects.php?id=" . $row['id'] . "'><button><i class='fa-solid fa-pen'></i></button></a> 
                  <a href='delete_subjects.php?id=" . $row['id'] . "'> <button type='submit' name='delete'><i class='fa-solid fa-trash-can'></i></button></a> 
                  </td>";
                  echo "</tr>";
              }
              ?>
